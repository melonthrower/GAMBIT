...
def get_dataset_dir(data_name):
    data_list = ['mobilebenchmark-hard']
    assert data_name in data_list, "Error, unknown eval dataset."
    data_split = None
    data_dir = None
    data_subset = None
    ...
    match data_name:
        ...
        case 'GAMBIT':
            data_dir = os.path.join(data_dir, "eval_data", "GAMBIT")
            data_split = "test"
            data_subset = ["mobilebenchmark-hard"]
